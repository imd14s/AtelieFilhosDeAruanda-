...
class InventoryControllerIntegrationTest {
    ...
    void setUp() {
        ...
        com.atelie.ecommerce.infrastructure.persistence.product.ProductVariantEntity variant = com.atelie.ecommerce.infrastructure.persistence.product.ProductVariantEntity
                .builder()
                .product(product)
                .sku("INV-TEST-SKU")
                .price(BigDecimal.TEN)
