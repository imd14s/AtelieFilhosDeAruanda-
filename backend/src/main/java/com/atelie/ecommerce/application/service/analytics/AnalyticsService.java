    ...
    public DashboardMetricsResponse getDashboardMetrics(String period) {
        ...
        Map<String, BigDecimal> salesByDateMap = validOrders.stream()
                .collect(Collectors.groupingBy(
                        ...
                        Collectors.reducing(BigDecimal.ZERO, OrderEntity::getTotalAmount, BigDecimal::add)));
        ...
        // 4. Top Products
        List<DashboardMetricsResponse.TopProduct> topProducts = orderItemRepository.findTopSellingProducts(startDate,
                PageRequest.of(0, 5));
