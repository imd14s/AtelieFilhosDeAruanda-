...
class ServiceEngineWiringTest {
    ...
    ServiceEngineWiringTest(ServiceOrchestrator orchestrator,
    ...
    void seedDb() {
        ...
        cfg.setProviderId(p.getId()); // usa provider_id (persistente)
    ...
    @Test
    void shouldExecuteUsingDbProviderAndConfig() {
        ServiceResult result = orchestrator.execute(
