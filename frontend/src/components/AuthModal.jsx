...
import { X, Mail, Lock, User, Key, Loader2, ArrowRight } from "lucide-react"; // Import User, Key, ArrowRight
...
const AuthModal = ({ isOpen, onClose }) => {
  ...
  const handleVerify = async (e) => {
    ...
    try {
      ...
      // Auto login logic or ask to login? Backend verify returns string.
      // Let's force login for security or auto-login if backend returns token (it doesn't yet).
      // For now, switch to LOGIN and pre-fill.
        ...
        <div className="p-8 md:p-10">
            ...
            <form onSubmit={handleLogin} className="space-y-5">
              ...
              <div className="mt-4 text-center">
                <p className="font-lato text-[11px] text-[#0f2A44]/40">
                  Ainda não tem conta? <span onClick={() => setView('REGISTER')} className="text-[#C9A24D] cursor-pointer hover:underline">Cadastre-se</span>
                </p>
              </div>
            </form>
          )}
          ...
          {view === 'REGISTER' && (
            <form onSubmit={handleRegister} className="space-y-5">
              ...
              <div className="mt-4 text-center">
                <p className="font-lato text-[11px] text-[#0f2A44]/40">
                  Já tem conta? <span onClick={() => setView('LOGIN')} className="text-[#C9A24D] cursor-pointer hover:underline">Fazer Login</span>
                </p>
              </div>
            </form>
          )}
          ...
          {view === 'VERIFY' && (
            <form onSubmit={handleVerify} className="space-y-5">
              ...
              <div className="mt-4 text-center">
                <p className="font-lato text-[11px] text-[#0f2A44]/40 cursor-pointer hover:underline" onClick={() => setView('REGISTER')}>
                  Voltar
                </p>
              </div>
            </form>
