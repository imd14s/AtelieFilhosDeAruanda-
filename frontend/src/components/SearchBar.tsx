...
const SearchBar: React.FC<SearchBarProps> = ({ searchTerm, setSearchTerm, onSearch, isMobile }) => {
    ...
    return (
        ...
        >
            ...
            <button
                type="submit"
                aria-label="Buscar"
                className={`absolute right-3 top-1/2 -translate-y-1/2 transition-all duration-300 ${isMobile
                        ? 'text-[#C9A24D]'
