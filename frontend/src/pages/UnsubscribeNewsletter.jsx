...
const UnsubscribeNewsletter = () => {
    ...
    useEffect(() => {
        ...
        // Some services pre-fetch links, so a deliberate action (button click) is safer than auto-submit on load,
        // but since we want friction-less unsubscribe according to email standards (One-Click), auto-submit is fine here.
        unsubscribeToken();
    }, [searchParams]);
