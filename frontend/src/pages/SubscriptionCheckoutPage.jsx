...
const SubscriptionCheckoutPage = () => {
    ...
    const [selectedProducts, setSelectedProducts] = useState([]); // {id, name, price, quantity}
    ...
    const handleAddProduct = (product) => {
        if (selectedProducts.length >= plan.maxProducts) {
    ...
    const handleSubmit = async () => {
        if (plan.type === 'CUSTOM' && selectedProducts.length < plan.minProducts) {
